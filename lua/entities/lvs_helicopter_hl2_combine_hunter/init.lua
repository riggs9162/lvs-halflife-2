...
function ENT:OnSpawn(PObj)
	...
	-- they dont have that much of an impact other than negativity on keeping it up
	-- self:AddWheel(Vector(15, 85, -70), 5, 200)
	-- self:AddWheel(Vector(15, -85, -70), 5, 200)
...
function ENT:SnapTailRotor()
	...
	local BonesToScale = {"Chopper.Tail", "Chopper.Blade_Tail"}
