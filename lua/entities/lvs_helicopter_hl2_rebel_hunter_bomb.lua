...
function ENT:Initialize()
	...
	self:SetSkin( 1 )
	self:SetSubMaterial( 0, "models/resist/helicopter_bomb01" )
	self:SetSubMaterial( 1, "models/resist/helicopter_bomb_off01" )
end
...
if SERVER then
	...
	function ENT:StartDetonationTimer()
		...
		self.snd = CreateSound( self, "ambient/alarms/alarm_citizen_loop1.wav" )
		self.snd:PlayEx( 0, 140 )
