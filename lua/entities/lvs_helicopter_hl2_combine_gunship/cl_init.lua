...
function ENT:PreDraw()
	...
	if not self.projTexture then
		...
		self.projTexture:SetFarZ(1024 * 16)
		self.projTexture:SetNearZ(16)
		self.projTexture:SetFOV(30)
		self.projTexture:SetColor(color_black)
		self.projTexture:SetBrightness(16)
...
function ENT:OnRemove()
	if self.projTexture then self.projTexture:Remove() end
end
